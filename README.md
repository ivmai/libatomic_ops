...
[![GitHub Actions build status](https://github.com/ivmai/libatomic_ops/actions/workflows/cmake-multi-platform.yml/badge.svg?event=push)](https://github.com/ivmai/libatomic_ops/actions?query=branch%3Amaster)
